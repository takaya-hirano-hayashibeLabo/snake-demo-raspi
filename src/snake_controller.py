...
import sys
DYNAMIXEL_PATH=str("/home/pi/hirano-dev/projects/snake-demo-raspi/pkg/DynamixelSDK/python/src")
...
ADDR_XH430_POSITION_D_GAIN = 30
ADDR_XH430_POSITION_P_GAIN = 84
ADDR_XH430_POSITION_I_GAIN = 20
...
DXL_MOVING_STATUS_THRESHOLD = 3                # Dynamixel moving status threshold, 20だと小さすぎ
...
class SnakeController():
    ...
    def write_goal_position(self,goal_positions:list):
        ...
        """
        # print(np.array(goal_positions)-DXL_MINIMUM_POSITION_VALUE)
        # print(DXL_MAXIMUM_POSITION_VALUE-np.array(goal_positions))

        for i,ID in enumerate(DXL_IDs):
            # print(ID)
            # self.packet_handler.write1ByteTxRx(self.port_handler,ID, ADDR_XH430_TORQUE_ENABLE, TORQUE_ENABLE)
            param_goal_position=[
